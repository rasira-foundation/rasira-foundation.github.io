...
export function AnalogClock({ hourDeg, minuteDeg }: AnalogClockProps) {
  return (
    <svg viewBox="0 0 100 100" className="analog-clock" aria-hidden="true">
      <line className="analog-clock-hand analog-clock-hour" x1="50" y1="50" x2="50" y2="16" transform={`rotate(${hourDeg} 50 50)`} />
      <line className="analog-clock-hand analog-clock-minute" x1="50" y1="50" x2="50" y2="4" transform={`rotate(${minuteDeg} 50 50)`} />
    </svg>
  );
}
